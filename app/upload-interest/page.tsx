...
import { columnHeadersInterestIB } from "../columnHeaders";
import { Box, Typography, useMediaQuery } from "@mui/material";

const UploadInterest = () => {
  ...
  const handleDataParsed = async (dataToCreate: CSVData[]) => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_URL}/api/interest`,
        {
          method: "POST",
          headers: {
  ...
  return (
    ...
    >
      ...
      <CSVUploader
        fileType="interest"
        columnHeaders={columnHeadersInterestIB}
